                ...
                if (pRenderTargetViewResource) {
                    ...
                    if (SUCCEEDED(pRenderTargetViewResource->QueryInterface(__uuidof(ID3D11Texture2D), (void**)&pTexture)) && pTexture) {
                        ...
                        if (needRecreate) {
                            ...
                            if (!dev && pDeviceContext) pDeviceContext->GetDevice(&dev);
                            if (dev) {
                        ...
                        if (g_BeforeUiCopy) {
                            ...
                            if (srcMsaa) {
                                ...
                                pDeviceContext->ResolveSubresource(g_BeforeUiCopy, 0, pTexture, 0, typed);
                            } else {
                                pDeviceContext->CopyResource(g_BeforeUiCopy, pTexture);
                            }
                        }
